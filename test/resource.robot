...
Open Browser To Login Page
    ...
    Run KeyWord If   '${BROWSER}'=='google-chrome'   Maximize Browser Window
    ...
    Run Keyword If  "\${SYSPWD}" not in $variables   Set Suite Variable   ${SYSPWD}   ${EMPTY}
...
Add New Project
    ...
    Wait Until Element Is Visible       css=input[name="local_pkey"]
    ...
    Sleep  200 milliseconds
    Run Keyword If   '${pwd}'=='${EMPTY}'    Click Element    css=input[name="local_pkey"]
    Sleep  200 milliseconds
    Input Text       user        ${user}
    Sleep  500 milliseconds
    Run Keyword If   '${pwd}'!='${EMPTY}'    Input Text       password    ${pwd}
    Click Element    id=add_my_project
    Sleep  500 milliseconds
    Wait Until Element Is Visible   css=button[alt="add new project"]
    Wait Until Element Is Visible   css=.alert-success
    Wait Until Element Is Not Visible   css=.alert-success
...
Open Linked Projects Tab
    ...
    Wait Until Page Contains Element  id=other_projects
    Wait Until Element Is Visible  id=other_projects
